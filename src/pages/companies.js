...
const Companies = ({ user, premiumInfo }) => {
  ...
  return (
    <>
      {openCompany && <Problems company={companies.find(company => company.name === openCompany)} onClose={handleClose} user={user} page={'companies'} premiumInfo={premiumInfo} />}
